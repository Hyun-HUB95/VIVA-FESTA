...
const EventListViewWrap = ({
  ...
  }, [hasMore, eventList.length, isLoading]);
    ...
    <Container className="EventListViewWrap-container py-4 px-4">
      ...
      <Row className="g-4">
        {eventList.map((event) => {
          ...
          // 이미 수정된 이미지 URL을 가져옵니다
          const imageUrl = `http://localhost:8080/uploads/event/main/${getCorrectedSrc(event.thumbUrl)}`;
